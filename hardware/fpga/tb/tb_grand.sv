// Testbench for the grand end-to-end demo: acq_stream_top at demo resolution.
// Same structure as tb_acq_stream, sized for 12 elements and a full record.

`timescale 1ns / 1ps

module tb_grand;

    localparam int N_ELEM   = 12;
    localparam int N_CH     = 12;
    localparam int DEPTH    = 512;
    localparam int SAMPLE_W = 16;
    localparam int ADDR_W   = $clog2(DEPTH);
    localparam int LEN      = 280;
    localparam int TOTAL    = 280;
